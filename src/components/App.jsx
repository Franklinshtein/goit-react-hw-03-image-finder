...
import ImageGallery from './ImageGallery/ImageGallery'; // перевірте шлях до ImageGallery
import Searchbar from './searchbar/Searchbar'; // перевірте шлях до Searchbar
import Button from './Button/Button'; // перевірте шлях до Button
import Modal from './Modal/Modal'; // перевірте шлях до Modal
import Loader from './Loader'; // перевірте шлях до Loader
